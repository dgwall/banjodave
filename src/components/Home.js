    ...
    <section>
      ...
      <article>
        ...
        <p>
          ...
          getting a sneak peek of my games, levels, and BanjoZine issues before
          they hit the public? That's exactly what I'm offering to my Patreon
          community (Launching Soon). If this seems like your kind of deal, I'd
          be stoked to have you join us on Patreon.
        </p>
        <p>
          If you just want to keep tabs on what's going down or sneak a peek at
          my day-to-day grind, join the BanjoCave on Discord, or follow me on
          Instagram, Twitter, and YouTube. I use these platforms to share
          whatever's cooking in the game dev kitchen and the ins and outs of my
          creations. So, if you're game, let's take this ride together.
        </p>
      </article>
    </section>
  );
